...
class DoctorVisitReminderScreen extends StatefulWidget {
  const DoctorVisitReminderScreen({super.key});

  @override
  State<DoctorVisitReminderScreen> createState() => _DoctorVisitReminderScreenState();
}
    ...
    return BaseScreen(
      ...
      content: Column(
        ...
        children: [
          ...
          // Doctor Visit Description
          Text(
            'Set a reminder for doctor\'s visit',
            textAlign: TextAlign.center,
            style: TextStyle(
              fontSize: 14,
